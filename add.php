...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `tournoi`(`id`, `nom_tournoi`, `jeu` , `date_debut` , `date_fin` , `description`) VALUES (NULL,'$nom_tournoi','$jeu','$date_debut','$date_fin','$description')";
         ...
         <form action="" method="post" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               <div class="col">
                  ...
                  <input type="text" class="form-control" name="nom_tournoi" placeholder="">
               </div>
               <div class="col">
                  <label class="form-label">Jeu:</label>
                  <input type="text" class="form-control" name="jeu" placeholder="">
               </div>
